...
$(".search-button a, .search-andalus").click(function() {
...
}(jQuery), $(".post-andalus a").attr("style", function(t, a) {
...
$(document).ready(function() {
	(function(e) {
		...
		e.get(t.attr("href"), function(n) {
			t.html(
' <strong>الموضوع السابق<i class="fa fa-angle-left"></i></strong><br/><div class="post-pager-title"><span>' +
				e(n).find(".post .post-title").text() + '</span></div>')
		}, "html");
		e.get(n.attr("href"), function(t) {
			n.html(
'<strong><i class="fa fa-angle-right"></i>الموضوع التالي</strong><br/><div class="post-pager-title"><span>' +
...
// Optimize Images
$('.post-andalus a').attr('style', function(i, src) {
